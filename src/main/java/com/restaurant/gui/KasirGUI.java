...
public class KasirGUI extends JFrame {
    ...
    private JPanel createGroupCard(int mejaNum, List<Pesanan> orders) {
        ...
        for (Pesanan p : orders) {
            for (DetailPesanan dp : p.getItems()) {
                ...
                sb.append(" <span style='color:#16a34a; font-size:10px;'>(Rp").append((int) dp.getSubtotal())
                        .append(")</span>");
                sb.append("</div>");
            }
        }
    ...
    private void prosesBayar(int mejaNum, List<Pesanan> orders, double total) {
        ...
        int choice = JOptionPane.showOptionDialog(this,
                ...
                "Konfirmasi Pembayaran", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE,
        ...
        if (choice >= 0) {
            ...
            if (choice == 0) { // Cash logic
                ...
                bayar = total; // Non-tunai dianggap pas
            }
    ...
    private void tampilkanStruk(int meja, List<Pesanan> orders, double total, double bayar, String metode) {
        ...
        struk.append("Tanggal: ").append(LocalDateTime.now().format(DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm")))
                .append("\n");
    ...
    private JPanel createTableHeaders() {
        ...
        gbc.gridx = 1;
        gbc.weightx = 0.5;
        JLabel h2 = new JLabel("Detail Pesanan");
        h2.setFont(f);
        h2.setForeground(c);
        panel.add(h2, gbc);
        ...
        gbc.gridx = 2;
        gbc.weightx = 0.3;
        JLabel h3 = new JLabel("Total & Aksi");
        h3.setFont(f);
        h3.setForeground(c);
        panel.add(h3, gbc);
