...
public class OrderEvent {
    ...
    private final String statusLama;
    private final String statusBaru;
    private final String roleUser; // role user yang melakukan perubahan
    private final String username; // username user yang melakukan perubahan
    ...
    public String getNotificationForRole(String targetRole) {
        ...
        switch (targetRole.toLowerCase()) {
            ...
            case "customer" -> {
                ...
                return switch (statusBaru) {
                    case "DIPROSES" ->
                        "Pesanan #" + pesananId + " diterima dan sedang dipersiapkan [" + waktu + "]";
                    case "SEDANG DIMASAK" ->
                        "Pesanan #" + pesananId + " sedang dimasak [" + waktu + "]";
                    case "SIAP DISAJIKAN" ->
                        "Pesanan #" + pesananId + " selesai dimasak, menunggu disajikan [" + waktu + "]";
                    case "DISAJIKAN" ->
                        "Pesanan #" + pesananId + " sudah disajikan, selamat menikmati! [" + waktu + "]";
                    case "LUNAS" ->
                        "Pesanan #" + pesananId + " telah lunas dibayar. Terima kasih! [" + waktu + "]";
                    default -> null;
                };
            }
        }
